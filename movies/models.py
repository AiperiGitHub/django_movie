...
class RatingStar(models.Model):
    """Звезда рейтинга"""
    value = models.SmallIntegerField("Значение", default=0)    # допускает значение от -32768 до +32767
...
# далее описываем поля, они же столбцы, таблицы
# name - атрибуты класса, по сути являются экземплярами класса полей

# TextField - не указываем текстовое ограничение
# SlugField - содержащая только буквы и цифры, подчеркивание и дефисы, исп.обычно только в url, должно быть уникальным

# метод str вернет строковое представление нашей модели
# class Meta это контейнер с некоторыми опциями meta данными прикрепленными к модели
